...
function(a){d.addNumericRefinement("price",">=",a.value[0]).search();d.addNumericRefinement("price","<=",a.value[1]).search()});jQuery('input[type="checkbox"]').checkbox()}function n(a){return 1E9<=a?(a/1E9).toFixed(0)+"G":1E6<=a?(a/1E6).toFixed(0)+"M":1E3<=a?(a/1E3).toFixed(0)+"K":a}var v=function(){var a={};a.width=Math.round(.8*c(window).width());a.height=Math.round(.8*c(window).height());return a}(),q="awpp,"+document.location.hostname,p=[{name:"plugin_class",title:"Plugin Type",disjunctive:!0,
type:"facet",sortFunction:r,topListIfRefined:!0,color_class:!0},{name:"installs",title:"Installs",disjunctive:!0,type:"slider",color_class:!0},{name:"num_ratings",title:"Votes",disjunctive:!0,type:"slider",color_class:!0},{name:"rating",title:"Rating",disjunctive:!0,type:"slider",color_class:!0},{name:"last_update_range",title:"Last update",disjunctive:!0,type:"facet",sortFunction:t,topListIfRefined:!0,color_class:!0},{name:"source_site",title:"security",disjunctive:!0,type:"facet",sortFunction:r,
...
null:a.name}),disjunctiveFacets:c.map(p,function(a){return a.disjunctive?a.name:null}),analyticsTags:q,ignorePlurals:!0},d=algoliasearchHelper(t,"wp_plugins",q);m.on("keyup change",function(){var a=m.val();a.trim()?(c("#input-loop").removeClass("glyphicon-flash"),c("#input-loop").addClass("glyphicon-remove")):(c("#input-loop").addClass("glyphicon-flash"),c("#input-loop").removeClass("glyphicon-remove"));d.setQuery(a).search()}).focus();d.on("change",function(a){var c;c="#q="+encodeURIComponent(a.query);
c+="&page="+(a.page+1);for(var b in a.facetsRefinements)c+="&"+encodeURIComponent(b)+"="+encodeURIComponent(a.facetsRefinements[b]);for(var d in a.disjunctiveFacetsRefinements&&"source_site"!=b)for(var e in a.disjunctiveFacetsRefinements[d])c+="&"+encodeURIComponent(d)+"="+encodeURIComponent(a.disjunctiveFacetsRefinements[d][e]);location.replace(c)});d.on("error",function(a){"AlgoliaSearchError"==a.name&&alert("Oops, something is not quite right.\nThis might be due to an outdated version of the plugin, in that case you must simply update the Addendio Plugin.\nOtherwise we will be happy to help, just get in touch at support@addendio.com")});
...
var r=function(a,c){return c.count-a.count},t=function(a,c){return a.value.localeCompare(c.value)},H=function(a){return function(c,b){if(c.refined!==b.refined){if(c.refined)return-1;if(b.refined)return 1}return a(c,b)}};jQuery("#q").focus(function(){c(this).data("placeholder",c(this).attr("placeholder"));c(this).attr("placeholder","")});jQuery("#q").blur(function(){c(this).attr("placeholder",c(this).data("placeholder"))})});